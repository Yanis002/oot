...
static RestrictionFlags sRestrictionFlags[] = {
    ...
    { SCENE_ENTRA, 0x00, 0x00, 0x10 }, //Project-A
...
u8 Item_Give(PlayState* play, u8 item) {
    ...
    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        ...
        /*if (item == ITEM_SAW) {
            SET_ITEMGETINF(ITEMGETINF_1F); //deku upgrade glitch
        }*/
...
// void Printf_Print(PlayState* play, u32 rgba, u32 xyz, const char* string){
//     ColorPos colorPos;

//     colorPos.rgba = rgba;
//     colorPos.xyz = xyz;

//     Printf_Process(play, colorPos, string);
// }

// //Actual print process
// void Printf_Process(PlayState* play, ColorPos colorPos, const char* string){
//     GfxPrint printer;

//     GfxPrint_Init(&printer);
//     GfxPrint_Open(&printer, play->state.gfxCtx->polyOpa.p);
...
//     play->state.gfxCtx->polyOpa.p = GfxPrint_Close(&printer);
