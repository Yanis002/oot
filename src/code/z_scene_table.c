...
void Scene_DrawConfigDekuTree(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 4810);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 4830);
}
...
void Scene_DrawConfigDodongosCavern(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5001);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5052);
}
...
void Scene_DrawConfigShadowTempleAndWell(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5432);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5464);
}
...
void Scene_DrawConfigWaterTemple(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5671);
    ...
    gSPSegment(POLY_XLU_DISP++, 0x06, SEGMENTED_TO_VIRTUAL(D_8012A330[((void)0, gSaveContext.nightFlag)]));
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 5776);
}
...
void Scene_DrawConfigIceCavern(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6102);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6136);
}
...
void Scene_DrawConfigGerudoTrainingGround(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6345);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6375);
}
...
void Scene_DrawConfigForestTemple(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6695);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6726);
}
...
void Scene_DrawConfigSpiritTemple(PlayState* play) {
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6786);

    gSPSegment(POLY_XLU_DISP++, 0x08,
               SEGMENTED_TO_VIRTUAL(sSpiritTempleEntranceTextures[((void)0, gSaveContext.nightFlag)]));

    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 6796);
}
...
void Scene_DrawConfigFireTemple(PlayState* play) {
    ...
    OPEN_DISPS(play->state.gfxCtx, "../z_scene_table.c", 7667);
    ...
    CLOSE_DISPS(play->state.gfxCtx, "../z_scene_table.c", 7690);
}
