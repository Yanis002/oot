...
EntranceInfo gEntranceTable[] = {
    ...
    ENTRANCE(0x5C, 0x08, 0, 1, 0x03, 0x03), ENTRANCE(0x5C, 0x08, 0, 1, 0x03, 0x03),
    // non-mq dungeons
    ENTRANCE(0x6E, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x6E, 0x00, 0, 1, 0x03, 0x03), // deku tree
    ENTRANCE(0x6E, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x6E, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x6E, 0x01, 1, 0, 0x02, 0x02), ENTRANCE(0x6E, 0x01, 1, 0, 0x02, 0x02),
    ENTRANCE(0x6E, 0x01, 1, 0, 0x02, 0x02), ENTRANCE(0x6E, 0x01, 1, 0, 0x02, 0x02),
    ENTRANCE(0x6F, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x6F, 0x00, 0, 1, 0x03, 0x03), // dc
    ENTRANCE(0x6F, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x6F, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x6F, 0x01, 1, 0, 0x02, 0x02), ENTRANCE(0x6F, 0x01, 1, 0, 0x02, 0x02),
    ENTRANCE(0x6F, 0x01, 1, 0, 0x02, 0x02), ENTRANCE(0x6F, 0x01, 1, 0, 0x02, 0x02),
    ENTRANCE(0x70, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x70, 0x00, 0, 1, 0x03, 0x03), // jabu
    ENTRANCE(0x70, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x70, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x70, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x70, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x70, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x70, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x71, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x71, 0x00, 0, 1, 0x03, 0x03), // forest 
    ENTRANCE(0x71, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x71, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x71, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x71, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x71, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x71, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x71, 0x02, 0, 1, 0x02, 0x02), ENTRANCE(0x71, 0x02, 0, 1, 0x02, 0x02),
    ENTRANCE(0x71, 0x02, 0, 1, 0x02, 0x02), ENTRANCE(0x71, 0x02, 0, 1, 0x02, 0x02),
    ENTRANCE(0x72, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x72, 0x00, 0, 1, 0x03, 0x03), // fire
    ENTRANCE(0x72, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x72, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x72, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x72, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x72, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x72, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x73, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x73, 0x00, 0, 1, 0x03, 0x03), // water
    ENTRANCE(0x73, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x73, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x73, 0x01, 1, 1, 0x03, 0x02), ENTRANCE(0x73, 0x01, 1, 1, 0x03, 0x02),
    ENTRANCE(0x73, 0x01, 1, 1, 0x03, 0x02), ENTRANCE(0x73, 0x01, 1, 1, 0x03, 0x02),
    ENTRANCE(0x74, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x74, 0x00, 0, 1, 0x03, 0x03), // spirit
    ENTRANCE(0x74, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x74, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x74, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x74, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x74, 0x01, 1, 1, 0x02, 0x02), ENTRANCE(0x74, 0x01, 1, 1, 0x02, 0x02),
    ENTRANCE(0x74, 0x02, 0, 0, 0x02, 0x02), ENTRANCE(0x74, 0x02, 0, 0, 0x02, 0x02), // right hand
    ENTRANCE(0x74, 0x02, 0, 0, 0x02, 0x02), ENTRANCE(0x74, 0x02, 0, 0, 0x02, 0x02),
    ENTRANCE(0x74, 0x03, 0, 0, 0x02, 0x02), ENTRANCE(0x74, 0x03, 0, 0, 0x02, 0x02), // left hand
    ENTRANCE(0x74, 0x03, 0, 0, 0x02, 0x02), ENTRANCE(0x74, 0x03, 0, 0, 0x02, 0x02),
    ENTRANCE(0x75, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x75, 0x00, 0, 1, 0x03, 0x03), // shadow
    ENTRANCE(0x75, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x75, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x75, 0x01, 0, 1, 0x02, 0x02), ENTRANCE(0x75, 0x01, 0, 1, 0x02, 0x02),
    ENTRANCE(0x75, 0x01, 0, 1, 0x02, 0x02), ENTRANCE(0x75, 0x01, 0, 1, 0x02, 0x02),
    ENTRANCE(0x76, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x76, 0x00, 0, 1, 0x03, 0x03), // botw
    ENTRANCE(0x76, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x76, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x77, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x77, 0x00, 0, 1, 0x03, 0x03), // ice cavern
    ENTRANCE(0x77, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x77, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x77, 0x01, 0, 1, 0x02, 0x02), ENTRANCE(0x77, 0x01, 0, 1, 0x02, 0x02),
    ENTRANCE(0x77, 0x01, 0, 1, 0x02, 0x02), ENTRANCE(0x77, 0x01, 0, 1, 0x02, 0x02),
    ENTRANCE(0x78, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x78, 0x00, 0, 1, 0x03, 0x03), // gtg
    ENTRANCE(0x78, 0x00, 0, 1, 0x03, 0x03), ENTRANCE(0x78, 0x00, 0, 1, 0x03, 0x03),
    ENTRANCE(0x7B, 0x00, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x00, 0, 1, 0x04, 0x02), // trials
    ENTRANCE(0x7B, 0x00, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x00, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x01, 0, 0, 0x04, 0x02), ENTRANCE(0x7B, 0x01, 0, 0, 0x04, 0x02), // tower
    ENTRANCE(0x7B, 0x01, 0, 0, 0x04, 0x02), ENTRANCE(0x7B, 0x01, 0, 0, 0x04, 0x02),
    ENTRANCE(0x7B, 0x02, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x02, 0, 1, 0x04, 0x02), // forest
    ENTRANCE(0x7B, 0x02, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x02, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x03, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x03, 0, 1, 0x04, 0x02), // water
    ENTRANCE(0x7B, 0x03, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x03, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x04, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x04, 0, 1, 0x04, 0x02), // shadow
    ENTRANCE(0x7B, 0x04, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x04, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x05, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x05, 0, 1, 0x04, 0x02), // fire
    ENTRANCE(0x7B, 0x05, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x05, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x06, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x06, 0, 1, 0x04, 0x02), // light
    ENTRANCE(0x7B, 0x06, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x06, 0, 1, 0x04, 0x02),
    ENTRANCE(0x7B, 0x07, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x07, 0, 1, 0x04, 0x02), // spirit
    ENTRANCE(0x7B, 0x07, 0, 1, 0x04, 0x02), ENTRANCE(0x7B, 0x07, 0, 1, 0x04, 0x02),
};
...
SceneTableEntry gSceneTable[] = {
    ...
    // non-mq
    TITLED_SCENE(ydan_nmq_scene, g_pn_06, 1, 19, 2),
    TITLED_SCENE(ddan_nmq_scene, g_pn_08, 1, 20, 3),
    TITLED_SCENE(bdan_nmq_scene, g_pn_07, 1, 21, 4),
    TITLED_SCENE(Bmori1_nmq_scene, g_pn_01, 2, 22, 5),
    TITLED_SCENE(HIDAN_nmq_scene, g_pn_03, 2, 18, 6),
    TITLED_SCENE(MIZUsin_nmq_scene, g_pn_04, 1, 23, 7),
    TITLED_SCENE(jyasinzou_nmq_scene, g_pn_05, 1, 25, 8),
    TITLED_SCENE(HAKAdan_nmq_scene, g_pn_02, 2, 24, 9),
    TITLED_SCENE(HAKAdanCH_nmq_scene, g_pn_54, 2, 24, 10),
    TITLED_SCENE(ice_doukutu_nmq_scene, g_pn_10, 0, 37, 0),
    TITLED_SCENE(men_nmq_scene, g_pn_11, 0, 27, 0),
    TITLED_SCENE(ganontika_nmq_scene, g_pn_09, 0, 26, 0),
};
