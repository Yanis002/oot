...
bool freezeWater(GlobalContext* play){
...
void func_8009D31C(GlobalContext* play) {
    if (freezeWater(play)) {
        return;
    }
...
void func_8009D974(GlobalContext* play) {
    if (freezeWater(play)) {
        return;
    }
...
// Scene Draw Config 2
void func_8009DD5C(GlobalContext* play) {
    if (freezeWater(play)) {
        return;
    }
...
void func_8009F1B4(GlobalContext* play) {
    if (freezeWater(play)) {
        return;
    }
...
void func_8009FB74(GlobalContext* play) {
    if (freezeWater(play)) {
        return;
    }
