...
/*
    PARAMETERS:
    - Collectible Drop: 0000 0000 0001 1111 - 0x001F
    - Item Type:        0000 0000 0000 1111 - 0x000F (Drop Mode = 2)
    - Drop Mode:        0000 0000 0110 0000 - 0x0060
    - Object Bank:      0000 0001 0000 0000 - 0x0100
    - Collectible Flag: 0111 1110 0000 0000 - 0x7E00
    - Trap Mode:        1000 0000 0000 0000 - 0x8000

    X-ROT PARAMETERS:
    - Item Subtype:     0000 0000 0001 1111 - 0x001F (Drop Mode = 2)

    Z-ROT PARAMETERS:
    - Enemy Type:       0000 0000 0000 1111 - 0x000F
