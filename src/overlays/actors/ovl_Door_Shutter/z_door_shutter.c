...
static ShutterSceneInfo sSceneInfo[] = {
    ...
    { SCENE_GANONTIKA, 0x0F },  { SCENE_HAKAANA_OUKE, 0x10 },
    { SCENE_YDAN_NMQ, 0x02 },       { SCENE_DDAN_NMQ, 0x03 },         { SCENE_GANONTIKA_NMQ, 0x0F }, 
    { SCENE_BDAN_NMQ, 0x04 },       { SCENE_BMORI1_NMQ, 0x05 },       { SCENE_HIDAN_NMQ, 0x08 },
    { SCENE_JYASINZOU_NMQ, 0x0A },  { SCENE_MIZUSIN_NMQ, 0x0B },      { SCENE_HAKADAN_NMQ, 0x0C },
    { SCENE_HAKADANCH_NMQ, 0x0C },  { SCENE_ICE_DOUKUTO_NMQ, 0x0D },  { SCENE_MEN_NMQ, 0x0E },
    { -1, 0x07 },
};
...
static BossDoorInfo D_80998288[] = {
    ...
    { SCENE_HIDAN_NMQ, SCENE_FIRE_BS, 0x01 },
    { SCENE_MIZUSIN_NMQ, SCENE_MIZUSIN_BS, 0x02 },
    { SCENE_HAKADAN_NMQ, SCENE_HAKADAN_BS, 0x03 },
    { SCENE_BMORI1_NMQ, SCENE_MORIBOSSROOM, 0x05 },
    { SCENE_JYASINZOU_NMQ, SCENE_JYASINBOSS, 0x06 },
    { -1, -1, 0x00 },
};
