...
// non-mq dungeons
DECLARE_ROM_SEGMENT(ydan_nmq_scene)
DECLARE_ROM_SEGMENT(ydan_nmq_room_0)
DECLARE_ROM_SEGMENT(ydan_nmq_room_1)
DECLARE_ROM_SEGMENT(ydan_nmq_room_2)
DECLARE_ROM_SEGMENT(ydan_nmq_room_3)
DECLARE_ROM_SEGMENT(ydan_nmq_room_4)
DECLARE_ROM_SEGMENT(ydan_nmq_room_5)
DECLARE_ROM_SEGMENT(ydan_nmq_room_6)
DECLARE_ROM_SEGMENT(ydan_nmq_room_7)
DECLARE_ROM_SEGMENT(ydan_nmq_room_8)
DECLARE_ROM_SEGMENT(ydan_nmq_room_9)
DECLARE_ROM_SEGMENT(ydan_nmq_room_10)
DECLARE_ROM_SEGMENT(ydan_nmq_room_11)

DECLARE_ROM_SEGMENT(ddan_nmq_scene)
DECLARE_ROM_SEGMENT(ddan_nmq_room_0)
DECLARE_ROM_SEGMENT(ddan_nmq_room_1)
DECLARE_ROM_SEGMENT(ddan_nmq_room_2)
DECLARE_ROM_SEGMENT(ddan_nmq_room_3)
DECLARE_ROM_SEGMENT(ddan_nmq_room_4)
DECLARE_ROM_SEGMENT(ddan_nmq_room_5)
DECLARE_ROM_SEGMENT(ddan_nmq_room_6)
DECLARE_ROM_SEGMENT(ddan_nmq_room_7)
DECLARE_ROM_SEGMENT(ddan_nmq_room_8)
DECLARE_ROM_SEGMENT(ddan_nmq_room_9)
DECLARE_ROM_SEGMENT(ddan_nmq_room_10)
DECLARE_ROM_SEGMENT(ddan_nmq_room_11)
DECLARE_ROM_SEGMENT(ddan_nmq_room_12)
DECLARE_ROM_SEGMENT(ddan_nmq_room_13)
DECLARE_ROM_SEGMENT(ddan_nmq_room_14)
DECLARE_ROM_SEGMENT(ddan_nmq_room_15)
DECLARE_ROM_SEGMENT(ddan_nmq_room_16)

DECLARE_ROM_SEGMENT(bdan_nmq_scene)
DECLARE_ROM_SEGMENT(bdan_nmq_room_0)
DECLARE_ROM_SEGMENT(bdan_nmq_room_1)
DECLARE_ROM_SEGMENT(bdan_nmq_room_2)
DECLARE_ROM_SEGMENT(bdan_nmq_room_3)
DECLARE_ROM_SEGMENT(bdan_nmq_room_4)
DECLARE_ROM_SEGMENT(bdan_nmq_room_5)
DECLARE_ROM_SEGMENT(bdan_nmq_room_6)
DECLARE_ROM_SEGMENT(bdan_nmq_room_7)
DECLARE_ROM_SEGMENT(bdan_nmq_room_8)
DECLARE_ROM_SEGMENT(bdan_nmq_room_9)
DECLARE_ROM_SEGMENT(bdan_nmq_room_10)
DECLARE_ROM_SEGMENT(bdan_nmq_room_11)
DECLARE_ROM_SEGMENT(bdan_nmq_room_12)
DECLARE_ROM_SEGMENT(bdan_nmq_room_13)
DECLARE_ROM_SEGMENT(bdan_nmq_room_14)
DECLARE_ROM_SEGMENT(bdan_nmq_room_15)

DECLARE_ROM_SEGMENT(Bmori1_nmq_scene)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_0)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_1)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_2)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_3)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_4)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_5)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_6)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_7)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_8)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_9)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_10)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_11)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_12)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_13)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_14)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_15)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_16)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_17)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_18)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_19)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_20)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_21)
DECLARE_ROM_SEGMENT(Bmori1_nmq_room_22)

DECLARE_ROM_SEGMENT(HIDAN_nmq_scene)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_0)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_1)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_2)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_3)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_4)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_5)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_6)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_7)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_8)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_9)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_10)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_11)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_12)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_13)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_14)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_15)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_16)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_17)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_18)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_19)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_20)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_21)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_22)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_23)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_24)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_25)
DECLARE_ROM_SEGMENT(HIDAN_nmq_room_26)

DECLARE_ROM_SEGMENT(MIZUsin_nmq_scene)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_0)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_1)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_2)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_3)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_4)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_5)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_6)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_7)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_8)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_9)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_10)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_11)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_12)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_13)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_14)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_15)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_16)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_17)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_18)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_19)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_20)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_21)
DECLARE_ROM_SEGMENT(MIZUsin_nmq_room_22)

DECLARE_ROM_SEGMENT(jyasinzou_nmq_scene)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_0)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_1)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_2)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_3)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_4)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_5)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_6)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_7)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_8)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_9)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_10)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_11)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_12)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_13)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_14)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_15)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_16)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_17)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_18)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_19)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_20)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_21)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_22)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_23)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_24)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_25)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_26)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_27)
DECLARE_ROM_SEGMENT(jyasinzou_nmq_room_28)

DECLARE_ROM_SEGMENT(HAKAdan_nmq_scene)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_0)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_1)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_2)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_3)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_4)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_5)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_6)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_7)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_8)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_9)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_10)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_11)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_12)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_13)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_14)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_15)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_16)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_17)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_18)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_19)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_20)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_21)
DECLARE_ROM_SEGMENT(HAKAdan_nmq_room_22)

DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_scene)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_0)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_1)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_2)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_3)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_4)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_5)
DECLARE_ROM_SEGMENT(HAKAdanCH_nmq_room_6)

DECLARE_ROM_SEGMENT(ice_doukutu_nmq_scene)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_0)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_1)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_2)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_3)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_4)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_5)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_6)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_7)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_8)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_9)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_10)
DECLARE_ROM_SEGMENT(ice_doukutu_nmq_room_11)

DECLARE_ROM_SEGMENT(men_nmq_scene)
DECLARE_ROM_SEGMENT(men_nmq_room_0)
DECLARE_ROM_SEGMENT(men_nmq_room_1)
DECLARE_ROM_SEGMENT(men_nmq_room_2)
DECLARE_ROM_SEGMENT(men_nmq_room_3)
DECLARE_ROM_SEGMENT(men_nmq_room_4)
DECLARE_ROM_SEGMENT(men_nmq_room_5)
DECLARE_ROM_SEGMENT(men_nmq_room_6)
DECLARE_ROM_SEGMENT(men_nmq_room_7)
DECLARE_ROM_SEGMENT(men_nmq_room_8)
DECLARE_ROM_SEGMENT(men_nmq_room_9)
DECLARE_ROM_SEGMENT(men_nmq_room_10)

DECLARE_ROM_SEGMENT(ganontika_nmq_scene)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_0)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_1)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_2)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_3)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_4)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_5)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_6)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_7)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_8)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_9)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_10)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_11)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_12)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_13)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_14)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_15)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_16)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_17)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_18)
DECLARE_ROM_SEGMENT(ganontika_nmq_room_19)
